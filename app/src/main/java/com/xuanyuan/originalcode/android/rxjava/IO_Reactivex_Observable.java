...
// * 邮件：424533553@qq.com
// * 说明：io.reactivex.Observable的源码研究
// */
//
///**
// * The Observable class is the non-backpressured,optionally multi-valued base reactive class that offers factory methods,
// * 可观察到的类是non-backpressured,基于活动类的的可选性提供工厂方法
// * <p>
// * intermediate operators and the ability to consume synchronous and/or asynchronous reactive dataflows.
// * 中间操作者有能力去消费 同步或异步的活性数据流
// * <p>
// * Many operators in the class accept {@code ObservableSource}(s), the base reactive interface for such non-backpressured flows
// * 类中的许多操作接收ObservableSource，基本的响应接口接口比如 non-backpressured flows
// * , which {@code Observable} itself implements as well.
// * <p>
// * The Observable's operators, by default, run with a buffer size of 128 elements (see {@link Flowable#bufferSize()}),
// * Observable的操作者,默认情况下，运行在一个128大小的bufferSize中,
// * that can be overridden globally via the system parameter {@code rx2.buffer-size}.
// * 这样可以全局覆盖通过系统参数
// * Most operators, however, have overloads that allow setting their internal buffer size explicitly.
// * 然而，大多数操作已经过载了 ，那些 允许显式地设置它们的内部缓冲区大小
// * <p>
// * The documentation for this class makes use of marble diagrams. The following legend explains these diagrams:
// * 这个类的文档利用大理石图，下面的释义解释了这些图
// * <p>
// * <img width="640" height="317" src="https://raw.github.com/wiki/ReactiveX/RxJava/images/rx-operators/legend.png" alt="">
// * <p>
// * The design of this class was derived from the <a href="https://github.com/reactive-streams/reactive-streams-jvm">Reactive Streams design and specification</a>
// * 这个类的设计来自于反应流设计和规范
// * by removing any backpressure-related infrastructure and implementation detail,
// * 通过移除backpressure-related 框架和实现细节
// * <p>
// * replacing the {@code org.reactivestreams.Subscription} with {@link Disposable} as the primary means to dispose of a flow.
// * 通过 Disposable取代了reactivestreams.Subscription 作为主要的处理flow的方式
// * <p>
// * The {@code Observable} follows the protocol onSubscribe onNext* (onError | onComplete)?
// * Observable遵循  onSubscribe中 onNext* (onError | onComplete) 的协议
// * <p>
...
// * stream可以通过Disposable的实例 提供给consumers 用户通过Observer.onSubscribe的方法
// * <p>
// * Unlike the {@code Observable} of version 1.x,
// * 不同于Observable的version1.x版
// * {@link #subscribe(Observer)} does not allow external disposal of a subscription and the {@code Observer} instance is expected to expose such capability.
// * Observer.subscribe 方法不允许订阅者外部处理 ，并且Observer的实例可能会暴露这样的能力如下
// *
// * <p>Example:
...
// * 这个序列可以通过dispose()方法来处理
// * d.dispose();
// * </code></pre>
// *
// * @param <T> the type of the items emitted by the Observable  Observable发出的项目类型
// * @see io.reactivex.observers.DisposableObserver
// */
//public abstract class IO_Reactivex_Observable<T> implements ObservableSource<T> {
//
//    /**
...
//     * 反应几个ObservableSources中迭代的一个ObservableSource ，该ObservableSource第一次要么发送一个item，要么发送一个终止通知
//     *
//     * <p>
...
//     *  方法amb 在特定的Scheduler中  默认下不进行操作
//     * </dl>
//     *
//     * @param <T>     the common element type 常见的基本元素类型
//     * @param sources an Iterable of ObservableSource sources competing to react first.
//     *                一个可迭代的   竞争第一反应的       ObservableSource集合
//     *                A subscription to each source will occur in the same order as in the Iterable.
//     *                每一个订阅源都将发生相同的Iterable 顺序
//     * @return an Observable that emits the same sequence as whichever of the source ObservableSources first emitted an item or sent a termination notification
//     * 一个被观察者将XX发出相同的序列, XX：最先发送一个item或者发送一个终止通知的 ObservableSources
...
//
//    /**
//     * Mirrors the one ObservableSource in an array of several ObservableSources that
//     * 返回了ObservableSources 数组中的 一个ObservableSource，
//     * first either emits an item or sends a termination notification.
//     * 该一个ObservableSource 第一次要么发送了一个item,要么发出了一个终止通知
//     *
//     * <dd>{@code ambArray} does not operate by default on a particular {@link Scheduler}.</dd>
//     * 方法ambArray在特定的Scheduler中  默认下不进行操作
//     *
//     * @param sources an array of ObservableSource sources competing to react first.
//     *                一个ObservableSource 数组对象竞争第一反应.
//     *                A subscription to each source will occur in the same order as in the array.
//     *                每个源的订阅顺序将和 source array中的顺序一样
//     * @return an Observable that emits the same sequence as whichever of the source ObservableSources first
//     * emitted an item or sent a termination notification
//     * 观察源中发送item或终止信息的顺序与 被观察者的 发出顺序是一样的
//     * @see <a href="http://reactivex.io/documentation/operators/amb.html">ReactiveX operators documentation: Amb</a>
//     */
...
//     * 返回默认的大小 或者无边界容量增长的提示
//     * <p>Delegates to {@link Flowable#bufferSize} but is public for convenience. 公开方便访问的 Flowable.bufferSize()
//     *
//     * <p>The value can be overridden via system parameter {@code rx2.buffer-size}
//     * 这个值可以通过修改系统硬件参数来改变
//     *
//     * <em>before</em> the {@link Flowable} class is loaded. 这个参数值是static ,所以它在Flowable类加载之前赋值加载
//     * @return the default 'island' size or capacity-increment hint  默认的缓冲大小 或者容量增量大小
//     */
